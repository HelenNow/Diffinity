...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        var test = new DbServer("test", Environment.GetEnvironmentVariable("testCs"));
        var test2 = new DbServer("test2", Environment.GetEnvironmentVariable("test2Cs"));

        string IndexPage = DbComparer.Compare(test,test2);  
        #region Optional
